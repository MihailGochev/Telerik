...
class SubsetSumsOfFElements
{
    ...
    static void Main()
    {
        ...
        Console.Write("Molq vyvedete broq chisla v masiva (N): ");
        int numberCount = int.Parse(Console.ReadLine());

        Console.Write("Molq vyvedete broq chisla v kombinaciqta (K): ");
        int combinationCount = int.Parse(Console.ReadLine());
        ...
        Permutation(combinationCount - 1, index, 0, combinationCount);
